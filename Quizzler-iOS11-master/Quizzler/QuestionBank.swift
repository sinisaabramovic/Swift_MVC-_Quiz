...
//  Quizzler
//
//  Created by Sinisa Abramovic on 29/10/2018.
//  Copyright © 2018 London App Brewery. All rights reserved.
//

// To store all of the Question used in app
// Represents DATA in MVC
import Foundation

class QuestionBank {
    // Property
    // var to create variable
    // list is equal to array of Question objects
    var list = [Question]()
    
    // init Event
    // When Question Bank is called
    init() {
